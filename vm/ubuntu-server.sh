...
# install packages
sudo apt install -y wget git zsh gpg vim unzip jq telnet curl htop btop python3-pip eza micro apt-transport-https sqlite3 docker.io docker-compose batcat
